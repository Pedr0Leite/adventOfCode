...
const lineArray = fs.readFileSync('input_day3_2019.txt').toString().split("\n");
for(i in lineArray) {
...
//Manhattan Distance of closest intersection of input wires is:
// 557
// Total Time Taken To Calculate: 142.042
// Fewest combined steps the wires must take to reach an intersection:
// 56410